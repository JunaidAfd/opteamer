...
public class UserRegistrationService {
    ...
    public void createUser(UserRegistrationDTO registrationDTO){
        ...
        User user=new User(registrationDTO.getUsername(),registrationDTO.getEmail(),passwordEncoder.encode(registrationDTO.getPassword()),new HashSet<>(Arrays.asList(role)));
