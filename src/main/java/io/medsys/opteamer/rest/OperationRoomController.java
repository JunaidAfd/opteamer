...
public class OperationRoomController {
    ...
    public ResponseEntity<List<OperationRoomDTO>> getAllOperationRooms() {
        List<OperationRoomDTO> operationRoomList = operationRoomService.getAllOperationRoom();
        return ResponseEntity.status(HttpStatus.CREATED).body(operationRoomList);
    }
