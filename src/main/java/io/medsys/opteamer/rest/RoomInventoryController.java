...
public class RoomInventoryController {
    ...
    public ResponseEntity<RoomInventoryDTO> getRoomInventoryById(@PathVariable(name = "assetId") Long assetId,@PathVariable(name = "roomId") Long roomId){
    ...
    public ResponseEntity<RoomInventoryDTO> updateInventory(@PathVariable(name = "assetId") Long assetId,@PathVariable(name="roomId") Long roomId,@RequestBody RoomInventoryDTO roomInventoryDTO){
